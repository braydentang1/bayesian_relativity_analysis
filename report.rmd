...
this corresponds to a deceivingly strong prior, namely that the different in estimated
effects of each level is the same. In math, this corresponds to setting $\beta_{1} - \beta_{2} \sim N(0, 2\epsilon)$ where $\epsilon$ is some number very close to 0, and $\beta_{1}, \beta_{2}$ are the two separate rating
